                        ...
                        <table class="table border">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>3 <i class="fa-solid fa-info-circle" data-toggle="tooltip" data-placement="top"
                                            title="Follow / No Follow / Sponsored"></i></td>
                                    <td>29/100</td>
                                    <td>50/100</td>
                                    <td>35/100</td>
                                    <td>14/100</td>
                                    ...
                                    <td><button class="btn bg-blue mr-2" data-toggle="modal" data-target="#exampleModal1"><i
                                                class="fa-solid fa-eye"></i></button><button class="btn bg-blue mr-2"><i
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="w-100 text-center">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="finish.php"
                                                                class="btn text-decoration-none bg-sidebar">Verify Now</a>
                                                            <a href="finish.php"

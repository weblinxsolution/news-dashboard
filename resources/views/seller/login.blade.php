...
<body class="bg-light">
    ...
    <div class="container">
        <form action="{{ Route('seller.loginCheck') }}" method="POST">
            ...
            <div class="mar-border py-5 p-4 text-center bg-white w-lg-50 mx-auto shadow">
                ...
                <div class="my-5">
                    <button type="submit" class="btn bg-blue text-white w-50">Login</button>
                </div>
                <div class="d-flex justify-content-between">
                    <a href="sellersignup.php" class="btn btn-outline-secondary hover text-black">Go to Registry</a>

        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-lg-4 col-6">
                    <!-- small box -->
                    <div class="small-box py-4 text-white bg-sidebar">
                        <div class="inner">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form class="steps" step="2">
                                                        <fieldset class="row">
                                                            <div class="mb-3 col-lg-6">
                                                                ...
                                                                <input type="number" value="390" id="disabledTextInput"
                                                                    class="form-control" placeholder="Enter Amount">
                                                            </div>
                                                            <div class="mb-3 col-lg-6">
                                                                <label for="disabledSelect" class="form-label">SPayment
                                                                    method</label>
                                                    ...
                                                    <form class="steps" step="3">
                                                        <fieldset class="row">
                                                            <div class="mb-3 col-lg-6">
                                                                <label for="disabledTextInput" class="form-label">Número
                                                                    de tarjeta</label>
                                                                <input type="number" value="390" id="disabledTextInput"
                                                                    class="form-control"

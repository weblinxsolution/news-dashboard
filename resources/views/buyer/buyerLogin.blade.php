...
<head>
    ...
    <title>Dashboard - Buyer - Login</title>
</head>
...
<body class="bg-light">
    ...
    <div class="container">
        <div class="mar-border py-5 p-4 text-center bg-white w-lg-50 mx-auto shadow">
            <h1 class="display-4 fw-bold text-blue my-4">Login</h1>
            <div class="mb-3">
            ...
            <div class="my-5">
                <a href="https://news.webcondesign.com/seller/sellerHome.php"
                    class="btn bg-blue text-white w-50">Login</a>
            </div>
            <div class="d-flex justify-content-between">
                <a href="buyerSignup.php" class="btn btn-outline-secondary hover text-black">Go to Registry</a>
                <a href="forgot-pass.php" class="text-blue">Forgot your Password ?</a>
            </div>
        </div>
    </div>

...
<head>
    ...
    <title>Dashboard - Buyer - Forgot Password</title>
</head>
...
<body class="bg-light">
    ...
    <div class="container">
        <div class="mar-border py-5 p-4 text-center bg-white w-lg-50 mx-auto shadow">
            <h1 class="display-4 fw-bold text-blue my-4">Forgot Password</h1>
            <div class="mb-3">
            ...
            <div class="my-5">
                <a href="buyerLogin.php" class="btn bg-blue text-white w-50">Confirm</a>
            </div>
